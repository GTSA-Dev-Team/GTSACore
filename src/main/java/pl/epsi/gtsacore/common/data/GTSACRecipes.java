...
public class GTSACRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        createFoundryAlloyingRecipe(provider, GTMaterials.Bronze.getFluid(4), GTMaterials.Copper.getFluid(3), GTMaterials.Tin.getFluid(1));

        FOUNDRY_ALLOYING_RECIPES.recipeBuilder("fdsfassfas")
                .inputFluids(GTMaterials.Copper.getFluid(3), GTMaterials.Tin.getFluid(1))
                .outputFluids(GTMaterials.Bronze.getFluid(4))
                .duration(4)
                .addData("max_err", 5)
                .save(provider);
    ...
    private static void createFoundryAlloyingRecipe(Consumer<FinishedRecipe> p, FluidStack output, FluidStack... inputs) {
